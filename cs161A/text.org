...
**** TODO On casting numbers
 ...
 So what do we do? We temporarily tell the C++ compiler "here, right here, treat this data like it's a different type".

 So we can do something like this to divide two integers:
