...
** DONE Booleans, logic, and quizzes
*** The if-statement
...
** DONE For-loops (and the shape of loops to come)[fn:8]
...
** DONE (Advanced) Arrays: the reasons for =for=
...
**** DONE What happens if you access outside the bounds of an array?
...
** DONE Data validation, the world's most annoying idiom
...
** DONE Arrays, again, and Pointers
...
*** DONE Creating and Initializing Vectors
#+begin_src cpp
...
*** DONE Accessing Vector Elements
**** Using [] vs at()
#+begin_src cpp
...
*** DONE Iterating Through Vectors
**** Index-Based Loops
#+begin_src cpp
...
** DONE Structs: Organizing Related Data
...
*** DONE Creating and Using Struct Variables
#+begin_src cpp
struct Book {
  string title;
  string author;
...
** DONE File I/O: Reading and Writing Files
...
*** DONE Introduction to File Input/Output
**** Why Use Files?
...
*** DONE Error Handling with Files
...
*** DONE Why Split Code into Multiple Files?
...
*** DONE Compiling Multi-File Programs
...
*** DONE Organizing Code by Purpose
**** Utility Functions
...
*** DONE Common Errors with Multi-File Programs
...
** DONE Common Algorithms & Problem Solving
...
*** DONE Problem-Solving Strategies
