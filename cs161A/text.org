...
And the specific constant =18446744073709551615= is =2^64 - 1=, which is just "the largest number you can spell with 64 binary digits when all of them are 1s." =string::npos= is defined to be that maximum value so that it will never collide with a legitimate index.
