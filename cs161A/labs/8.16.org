...
(what should power(5, 0) be? what about power(0, 0), or a negative
exponent?). Even if your first version doesn't handle everything
perfectly, this process will help you see where improvements are needed.
